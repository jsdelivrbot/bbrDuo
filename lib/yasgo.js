...
var cdnList = exports.cdnList = {
    ...
    "xtag": "https://rawgit.com/x-tag/core/master/dist/x-tag-polyfilled.min.js",
...
function loadDependencies() {
    ...
    return new Promise(function (resolve, reject) {
        if (cdnLoaded) {
            ...
            (0, _loader.loadScript)("https://cdn.rawgit.com/brython-dev/brython/3.5.1/www/src/brython.js").then(function () {
                window.brython();
                window.None = null;
