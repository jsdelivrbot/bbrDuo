(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("yasgo", [], factory);
	else if(typeof exports === 'object')
		exports["yasgo"] = factory();
	else
		root["yasgo"] = factory();
...
var cdnList = exports.cdnList = {
    "ace": "https://cdnjs.cloudflare.com/ajax/libs/ace/1.3.3/ace.js",
    "jquery": "https://code.jquery.com/jquery-3.3.1.min.js",
    "xtag": "https://cdn.jsdelivr.net/gh/x-tag/core@master/dist/x-tag-polyfilled.min.js",
...
var number = exports.number = undefined;
...
function imgReady(imgObject, callback) {
    return new Promise(function (res, rej) {
        ...
        if (imgObject.complete) {
            ...
            imgObject.addEventListener("load", loaded);
...
function loadGoogleAPI(apiKey) {
    ...
    return new Promise(function (resolve, reject) {
        if (gapiLoaded === true) {
            ...
            (0, _loader.loadScript)("//apis.google.com/js/client.js").then(function () {
    ...
    return new Promise(function (resolve, reject) {
        if (youtubeIFrameLoaded === true) {
            ...
            (0, _loader.loadScript)(_loader.cdnList.jquery).then(function () {
                ...
                return (0, _loader.loadScript)("http://www.youtube.com/iframe_api", function () {});
            });
        }
    });
}
...
var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; /**
                                                                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                                                                               *  - Release
                                                                                                                                                                                                                                                                               * V1.2.0
                                                                                                                                                                                                                                                                               *  - Binarie system (use as node exe) added
                                                                                                                                                                                                                                                                               * V1.4.0
                                                                                                                                                                                                                                                                               *  - Major changes, starting x-tag implementaion (deprecated because of support)
                                                                                                                                                                                                                                                                               * V1.6.0
                                                                                                                                                                                                                                                                               *  - Cleaning modules
                                                                                                                                                                                                                                                                               */

exports.default = yasgo;

var _index = __webpack_require__(333);

var _ace = __webpack_require__(334);

var _ready = __webpack_require__(126);

var _youtube = __webpack_require__(335);

var _yahoo = __webpack_require__(338);

var _python = __webpack_require__(339);
...
var _ui = __webpack_require__(345);

var yasgoInitialized = false;

function yasgo(arg1, arg2, arg3) {
    if (yasgoInitialized === false) {
        if (_utils.utils.device.info().os !== "Windows" && _utils.utils.device.info().browser !== "Chrome") {
            if (window !== undefined) {
        ...
        case "string":
            switch (arg2) {
                case undefined:
                    (0, _ready.ready)().then(function () {
                        (0, _application.applyWebAppStyle)();
                        (0, _loader.loadScript)(arg1).then(function () {});
                    });
                    break;
                case "module":
                    // if second param is module
                    (0, _ready.ready)().then(function () {
                        (0, _application.applyWebAppStyle)();
                        (0, _loader.loadScript)(arg1, "module").then(function () {});
                    });
                    break;
            }
            break;
...
// Builtin
yasgo.get = yasgo.getFile = _loader.httpGet;
yasgo.post = _loader.httpPost;
yasgo.cdn = _loader.cdnList;
yasgo.loadScript = yasgo.load = yasgo.getScript = _loader.loadScript;
yasgo.loadCss = yasgo.getCss = _loader.loadCss;
yasgo.writeCSS = yasgo.writecss = yasgo.writeCss = _loader.writeCSS;
yasgo.event = _index.event;
yasgo.utils = _utils.utils;
yasgo.ui = _ui.ui;
// Ext

yasgo.Ace = _ace.Ace;
yasgo.Youtube = _youtube.youtube;
yasgo.Yahoo = _yahoo.yahoo;
yasgo.Python = _python.python;
...
var _number = __webpack_require__(91);
...
function Editor() {
    ...
    return new Promise(function (resolve, reject) {
        (0, _loader.loadScript)(_loader.cdnList.ace).then(function () {
            var valueHasBeenSetByCode = false;
            // Load jquery and ace
            var editorInstance, instanceContainer, randomAssignedID, editorReturnObject;
            // Name to be applied to container

            randomAssignedID = "_instance_" + (0, _number.randomUnique)();
...
var youtube = exports.youtube = undefined;
...
var _loadDependencies = __webpack_require__(127);

/* global gapi*/

// For test purpose only
var currentAPIKey = "AIzaSyBIE8mXhMwAdyRRgS86nzOJQtAtTIP8OPk";
...
/* eslint no-unused-vars:0 vars-on-top:0*/
...
function Player() {
    ...
    return new Promise(function (resolve, reject) {
        (0, _loadDependencies.loadYoutubeIFrameApi)().then(function LOADED() {
            // START
            var resolveAfterReady = true;

            var PlayerClass = {
                // Sets container width and height to 100%
                fill: function fill() {
                ...
                loadVideoById: function () {
                    ...
                    function loadVideoById(_x2) {
                        return _ref.apply(this, arguments);
                    }

                    return loadVideoById;
                }(),
                setVolume: function setVolume(amount) {
                    PlayerClass.instance.setVolume(amount);
                },
                _internReady: function _internReady() {},
                _internStateChange: function _internStateChange() {},
                remove: function remove() {
                    PlayerClass.container.remove();
                }
            };
            ...
            var name = options.parent;
            if (options.parent === undefined) {
                name = "_youtube_" + (0, _number.randomUnique)();
                var playerContainer = $("<div></div>").attr("id", name);
                playerContainer.appendTo($("body")).css({
                    "display": "block" // default to hidden, may change in future updates
                });
            }
            var playerInstance = new YT.Player(name, {
                height: options.height || "100%",
                width: options.width || "100%",
                events: {
                    "onReady": function onReady(event) {
                        // The intern ready is used for the appendTo() function
                        PlayerClass._internReady();
                        // Check if first time, to resolve
                        if (resolveAfterReady) {
                            resolveAfterReady = false;
                            PlayerClass.instance = playerInstance;
                            PlayerClass.container = $("#" + name);
                            resolve(PlayerClass);
                        }
                        if (options.onReady) {
...
exports.yahoo = undefined;

var _loader = __webpack_require__(46);

var yahoo = exports.yahoo = undefined;

exports.yahoo = yahoo = {
    cors: function cors(url) {
        var autoParse = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;

        /* global $*/
        return new Promise(function (resolve, reject) {
            (0, _loader.loadScript)(_loader.cdnList.jquery).then(function () {
                $.getJSON("http://query.yahooapis.com/v1/public/yql?q=" + encodeURIComponent("select * from htmlstring where url='" + url + "' AND xpath='//html'") + "&format=json&env=store%3A%2F%2Fdatatables.org%2Falltableswithkeys&callback=?", function (data) {
                    if (autoParse) {
                        /* eslint max-len:0 */
                        data.query.results.result = data.query.results.result.replace(/<\s*(script|iframe)[^>]*>(?:[^<]*<)*?\/\1>/g, "").replace(/(<(\b(img|style|head|link)\b)(([^>]*\/>)|([^\7]*(<\/\2[^>]*>)))|(<\bimg\b)[^>]*>|(\b(background|style)\b=\s*"[^"]*"))/g, "");
                    }
                    resolve(data.query.results.result);
                }).fail(function (d) {
                    reject(d);
                });
            });
...
exports.python = undefined;

var _loader = __webpack_require__(46);

var python = exports.python = undefined;
var cdnLoaded = false;

function injectBuiltins(B) {
    B.injectModule("yasgo", {
...
function loadDependencies() {
    ...
    return new Promise(function (resolve, reject) {
        if (cdnLoaded) {
            window.brython();
            callback(window.__BRYTHON__);
            resolve(window.__BRYTHON__);
        } else {
            (0, _loader.loadScript)("https://cdn.jsdelivr.net/gh/brython-dev/brython@3.5.1/www/src/brython.js").then(function () {
                window.brython();
                window.None = null;
                window.__BRYTHON__.compile = function (code) {
                    return window.__BRYTHON__.py2js(code, "", "").to_js();
                };
                window.__BRYTHON__.injectModule = function (nameToAssign, moduleObj) {
                    var $B = window.__BRYTHON__,
                        name,
                        attr;

                    moduleObj.__class__ = $B.$ModuleDict;
                    moduleObj.__name__ = nameToAssign;
                    moduleObj.__repr__ = moduleObj.__str__ = function () {
                        return "<module '" + nameToAssign + "' (built-in)>";
                    };
                    $B.imported[nameToAssign] = $B.module[nameToAssign] = moduleObj;
                    // set attribute "name" of functions
                    for (attr in moduleObj) {
                        if (typeof moduleObj[attr] === "function") {
                            name = attr;
                            while (name.charAt(0) === "$") {
                                name = name.substr(1);
                            }
                            moduleObj[attr].$infos = { __name__: name };
                        }
                    }
                };
                injectBuiltins(window.__BRYTHON__);
                callback(window.__BRYTHON__);
                resolve(window.__BRYTHON__);
                cdnLoaded = true;
            });
...
exports.python = python = {
    compile: function compile(code) {
        ...
        return new Promise(function (resolve, reject) {
            loadDependencies().then(function (B) {
                var codeResult;

                try {
                    codeResult = B.compile(code);
                    callback(false, codeResult);
                    resolve(codeResult);
                } catch (ex) {
                    callback(ex, "");
                    reject(ex);
    ...
    runApp: function runApp(src, callback) {
        return new Promise(function (resolve, reject) {
            loadDependencies().then(function (ok) {
                var tmpState = false,
                    brotherTag = document.getElementsByTagName("script")[0],
                    scriptTag = document.createElement("script");
                ...
                scriptTag.onerror = scriptTag.onabort = function (err) {
                    console.log(err);
                    reject(err);
                };
                brotherTag.parentNode.insertBefore(scriptTag, brotherTag);
...
var _device = __webpack_require__(342);

var _audio = __webpack_require__(343);

// This module is standalone
var utils = exports.utils = undefined;
...
var string = exports.string = undefined;

exports.string = string = {
    longToShort: function longToShort(str) {
        var amount = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 48;
        ...
        if (typeof str === "string") {
            ...
            console.log(Error("No string provided"));
            return str;
        }
    },
...
var audio = exports.audio = undefined;

function loadAudio(location) {
...
var appliedAlready = false; /* eslint max-len:0 */
function applyWebAppStyle() {
    if (!appliedAlready) {
        (0, _loader.writeCSS)("html,\r\n        body,\r\n        #root,\r\n        .root {\r\n            margin: 0px;\r\n            padding: 0px;\r\n            width: 100%;\r\n            height: 100%;\r\n        }\r\n        body {\r\n            overscroll-behavior-y: contain;\r\n        }\r\n        div:focus {\r\n            outline: none;\r\n        }\r\n        .noselect,\r\n        .no-select {\r\n            -webkit-touch-callout: none;\r\n            -webkit-user-select: none;\r\n            -khtml-user-select: none;\r\n            -moz-user-select: none;\r\n            -ms-user-select: none;\r\n            user-select: none;\r\n        }");
        appliedAlready = true;
    }
}
...
var ui = exports.ui = _component.component;
...
function component() {
    ...
    componentElement.to = function (parent) {
        $element.appendTo($(parent));
        return componentElement;
    };
    componentElement.html = function (content) {
        $element.html(content);
        return componentElement;
    };
    componentElement.css = function (content) {
        $element.css(content);
        return componentElement;
    };
